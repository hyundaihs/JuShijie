...
import kotlinx.android.synthetic.main.layout_case_list_item.view.*
 ...
 */
class CaseAdapter(val data: ArrayList<CompanyInfo>) : MyBaseAdapter(R.layout.layout_case_list_item) {
